...
5. **Speech** — press the mapped key to invoke a local speech-to-text tool, release to stop (`Speech/SpeechToolProcessController` + Core port)
...
- ControllerFlow.Core.Tests: 139 tests
- ControllerFlow.Windows.Tests: 6 tests
